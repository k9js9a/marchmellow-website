      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              ref={iconRef}
              className="sm-icon will-change:transform relative inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
                className="sm-icon-line will-change:transform absolute top-1/2 left-1/2 h-0.5 w-full -translate-x-1/2 -translate-y-1/2 rounded-xs bg-current"
              />
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v will-change:transform absolute top-1/2 left-1/2 h-0.5 w-full -translate-x-1/2 -translate-y-1/2 rounded-xs bg-current"
              />
            </span>
          </button>
        </header>
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 z-10 flex h-full flex-col overflow-y-auto bg-white p-[6em_2em_2em_2em] backdrop-blur-md"
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className="sm-socials-link relative inline-block py-0.5 text-[1.2rem] font-medium text-[#111] no-underline transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
