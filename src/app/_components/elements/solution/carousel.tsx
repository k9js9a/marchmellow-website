      ...
      >
        ...
        <AnimatePresence mode="wait">
          ...
          <motion.div
            ...
            className="absolute inset-0 my-1 flex items-center justify-center"
          ...
          >
            <CurrentLogo className="fill-muted-foreground h-20 max-h-[80%] w-20 max-w-[80%] object-contain md:h-32 md:w-32" />
          </motion.div>
        </AnimatePresence>
      </motion.div>
    );
...
function Carousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(
    () => [
      { name: "Nextjs", id: 1, img: SiNextdotjs },
      { name: "Expo", id: 2, img: SiExpo },
      { name: "Appwrite", id: 3, img: SiAppwrite },
      { name: "Clerk", id: 4, img: SiClerk },
      { name: "Posthog", id: 5, img: SiPosthog },
      { name: "Sentry", id: 6, img: SiSentry },
      { name: "Stripe", id: 7, img: SiStripe },
      { name: "N8N", id: 8, img: SiN8N },
      { name: "Vercel", id: 9, img: SiVercel },
      { name: "Nestjs", id: 10, img: SiNestjs },
      { name: "Netlify", id: 11, img: SiNetlify },
      { name: "Supabase", id: 12, img: SiSupabase },
    ],
    [],
  );
