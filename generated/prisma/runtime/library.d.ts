...
> = {
  ...
  >]: DynamicModelExtensionOperationFn<TypeMap, M, P>;
    ...
    "fields",
    keyof ExtArgs["model"][Uncapitalize<M & string>]
  >, TypeMap["model"][M]["fields"]> & Record<symbol, {
...
> {
  extArgs: ExtArgs;
  <
    R_ extends Partial<Record<TypeMap["meta"]["modelProps"] | "$allModels", unknown>>,
    R,
    M_ extends Partial<Record<TypeMap["meta"]["modelProps"] | "$allModels", unknown>>,
    M,
    Q_ extends Partial<Record<| TypeMap["meta"]["modelProps"]
        | "$allModels"
        | keyof TypeMap["other"]["operations"]
        | "$allOperations", unknown>>,
    C_ extends Partial<Record<string, unknown>>,
    C,
...
export declare type GetOmit<
  ...
  ExtraType = never,
> = Partial<Record<(string extends keyof R ? never : keyof R) | BaseKeys, | boolean
    | ExtraType>>;
...
export declare type InternalArgs<
  ...
  Q = Record<string, Record<string, unknown>>,
...
export declare type QueryOptions = {
  query: Record<string, | Record<string, ModelQueryOptionsCb>
      | QueryOptionsCb>;
};
